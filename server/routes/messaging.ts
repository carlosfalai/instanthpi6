...
const messageTemplates = [
  {
    ...
    content: "Hello {patient_name}, this is a reminder about your upcoming appointment at InstantHPI. Please confirm your attendance by replying to this message. If you need to reschedule, please call us."
  },
  {
    id: crypto.randomUUID(),
    name: "Vaccination Reminder",
    content: "Hello {patient_name}, it's time for your vaccination. Please schedule an appointment at your earliest convenience to ensure your immunization is up-to-date."
  },
  {
    id: crypto.randomUUID(),
    name: "Follow-up Check",
    content: "Hello {patient_name}, we're following up on your recent visit. How are you feeling? Please let us know if you have any questions or concerns about your treatment."
  },
  {
    id: crypto.randomUUID(),
    name: "Lab Results Notification",
    content: "Hello {patient_name}, your lab results are available. Please schedule a follow-up appointment to discuss your results with your healthcare provider."
  },
  {
    id: crypto.randomUUID(),
    name: "Medication Refill",
    content: "Hello {patient_name}, this is a reminder that your medication refill is due. Please contact us if you need a prescription renewal."
  }
];
