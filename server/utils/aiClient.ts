...
export interface AIClient {
  generateCompletion: (messages: Array<{role: string, content: string}>, systemPrompt?: string) => Promise<string>;
  provider: string;
  model: string;
}
...
class OpenAIClient implements AIClient {
  ...
  async generateCompletion(messages: Array<{role: string, content: string}>, systemPrompt?: string): Promise<string> {
