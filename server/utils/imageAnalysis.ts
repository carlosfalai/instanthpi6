      ...
      messages: [
        {
          role: "system",
          content:
            "You are a document verification system specifically trained to identify Quebec's RAMQ health insurance cards. Analyze the provided image and determine if it is a valid RAMQ card.",
        },
        {
          role: "user",
          content: [
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a document information extraction system specialized in RAMQ health insurance cards from Quebec. Extract key information from the provided card image.",
        },
        {
          role: "user",
          content: [
