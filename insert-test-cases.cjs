...
const testCases = [
  {
    ...
    additional_notes: 'Patient fumeur, 20 paquets-années'
  },
  {
    ...
    additional_notes: 'Antécédents familiaux de migraines'
  },
  {
    ...
    medication_allergies: 'Aucune allergie connue',
    pregnancy_status: 'Non enceinte',
    additional_notes: 'Consommation d\'alcool modérée'
  },
  {
    ...
    medication_allergies: 'Aucune allergie connue',
    pregnancy_status: 'Non applicable',
    additional_notes: 'Travail physique, surpoids'
  },
  {
    ...
    pregnancy_status: 'Non applicable',
    additional_notes: 'Ex-fumeuse, arrêt il y a 5 ans'
  }
];
