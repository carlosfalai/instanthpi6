...
async function testUpdatedFormSubmission() {
  console.log('🧪 Testing updated patient form submission...\n');
  ...
  try {
    console.log('📝 Inserting test consultation with updated schema...');
