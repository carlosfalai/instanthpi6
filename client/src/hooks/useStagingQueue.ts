...
import { StagedMessage, StagingQueueState, STORAGE_KEYS, DEFAULT_TIMER_CONFIG } from '@/types/staging';
...
export function useStagingQueue() {
  ...
  const markAsError = useCallback((messageId: string, error: string) => {
