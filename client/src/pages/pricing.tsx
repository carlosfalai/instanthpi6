...
import { Check, Sparkles, ArrowRight, Zap, Building2, User, Crown } from "lucide-react";
      ...
      <section className="relative py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1
            ...
            style={{ fontFamily: "Outfit, sans-serif" }}
          >
            Choisissez votre <span className="text-gradient-amber">forfait</span>
          </h1>

          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12">
            Des solutions adaptées à chaque taille de pratique médicale. Commencez gratuitement et
              ...
              return (
                ...
                >
                  ...
                  <CardHeader className="pb-4">
                    ...
                    >
                      <Icon
                        className={`h-6 w-6 ${tier.highlighted ? "text-primary" : "text-muted-foreground"}`}
                      />
                    </div>
