      ...
      <div className="p-6">
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Leverage the power of Claude 3.7 Sonnet for advanced medical AI capabilities and development assistance.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p>
              Claude 3.7 Sonnet is a state-of-the-art language model that can assist with a wide range of tasks, 
              including medical documentation, treatment plans, sentiment analysis, image recognition, and code generation.
            </p>
            <p className="mt-2">
        ...
        <Tabs defaultValue="features" value={activeTab} onValueChange={setActiveTab} className="mb-6">
