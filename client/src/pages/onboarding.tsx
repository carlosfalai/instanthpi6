...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 overflow-hidden relative">
            ...
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-secondary/10 rounded-full blur-[120px] animate-aura" style={{ animationDelay: "-2s" }} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {specialties.map((s) => (
                ...
                >
                  ...
                  <span className="text-sm text-muted-foreground mt-1">Sélectionner ce domaine</span>
                </button>
              ))}
            </div>
          )}
            ...
            <div className="text-center space-y-6 py-4">
              ...
              <div className="text-left bg-white/5 rounded-2xl p-6 space-y-2">
                <p>
                  ...
                  <span className="font-semibold uppercase">{specialties.find((s) => s.id === specialty)?.name}</span>
                </p>
                <p>
              ...
              <p className="text-muted-foreground max-w-sm mx-auto leading-relaxed">
                Une fois validé, InstantConsult générera automatiquement vos formulaires, vos modèles d'IA
                et préparera l'URL à partager avec vos patients.
              </p>
