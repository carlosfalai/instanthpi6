            ...
            <div className="p-4">
              <div className="mb-6">
                ...
                <div className="space-y-2 text-sm text-gray-400">
                  <p>
                    <span className="text-gray-500">Name:</span> {selectedPatient.name}
                  </p>
                  ...
                  <div className="space-y-3 border border-[#333] rounded-md p-3 bg-[#1e1e1e]">
                    ...
                    <div className="p-3 border border-[#333] rounded-md bg-[#252525]">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <Badge
                          className={
                            selectedPatient?.ramqVerified ? "bg-green-700" : "bg-amber-700"
                          }
                        >
                      ...
                      <p className="text-sm text-gray-400 mb-2">
                        Patient needs to send a photo of their RAMQ health insurance card for
                        verification.
                      </p>
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-5 w-5 transform transition-transform ${isCommunicationsExpanded ? "rotate-180" : ""}`}
                  />
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-4">
                <div className="space-y-4">
                  ...
                  <div className="bg-[#222] p-4 rounded-md border border-[#333]">
                    ...
                    <p className="text-sm text-gray-400 mb-2">
                      Patient requests refill for hypertension medication. Needs your approval.
                    </p>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="bg-[#222] p-4 rounded-md border border-[#333]">
                    ...
                    <p className="text-sm text-gray-400 mb-2">
                      Blood work results received. Review and communicate findings to patient.
                    </p>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="bg-[#222] p-4 rounded-md border border-[#333]">
                    ...
                    <p className="text-sm text-gray-400 mb-2">
                      Patient needs a doctor's note for work absence due to recent illness.
                    </p>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="bg-[#222] p-4 rounded-md border border-[#333]">
                    ...
                    <p className="text-sm text-gray-400 mb-2">
                      Follow-up scheduled for antibiotic treatment. Check patient progress.
                    </p>
                    <div className="flex justify-between items-center">
                    ...
                    {(patientMessages || []).slice(-5).map((message) => (
                      <div key={message.id} className="flex items-start">
                        {message.isFromPatient ? (
                          <div
                            className={`flex-shrink-0 w-6 h-6 rounded-full ${getAvatarColor(selectedPatient.id)} flex items-center justify-center mr-2`}
                          >
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between">
                            <span className="text-xs font-medium text-white">
                              {message.isFromPatient ? selectedPatient.name : "You"}
                            </span>
                  ...
                  onSubmit={async (e) => {
                    ...
                    try {
                      const response = await fetch(
                        `/api/spruce/patients/${selectedPatient.spruceId || selectedPatient.id}/messages`,
                        {
                          method: "POST",
                          headers: {
                            "Content-Type": "application/json",
                ...
                <div className="p-3 border-t border-[#333]">
                  <form
                    onSubmit={async (e) => {
                      ...
                      try {
                        const response = await fetch(
                          `/api/spruce/patients/${selectedPatient.id}/messages`,
                          {
                            method: "POST",
                            headers: {
                              "Content-Type": "application/json",
