...
import { EliteLayout, EliteResultDashboard, EliteButton } from "@/components/elite";
          ...
          <EliteResultDashboard
            ...
            initialSections={[
              ...
              },
              {
                ...
                title: "SOAP Note",
                content:
                  "S: Urinary Tract Infection symptoms.\n\nO: Acute uncomplicated cystitis.\n\nA: UTI confirmed.",
                isVisible: true,
                isExpanded: false,
              },
              {
                ...
                content:
                  "1. Antibiotic therapy: Phosphomycin 3g sachet once.\n2. Hydration.\n3. Follow up if symptoms persist > 3 days.",
                isVisible: true,
                isExpanded: true,
              },
            ]}
