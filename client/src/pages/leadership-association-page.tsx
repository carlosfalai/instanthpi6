          ...
          <Card className="mb-8 bg-[#1e1e1e] border-gray-800">
            ...
            <CardContent>
              <p className="text-gray-300">
                The InstantHPI leadership association brings together experienced medical professionals and business experts 
                to revolutionize medical documentation and patient care through innovative technology solutions.
              </p>
            </CardContent>
          </Card>
