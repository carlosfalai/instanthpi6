...
import { Search, RefreshCw, Send, Loader2, MessageSquare, User, Clock } from "lucide-react";
...
export default function DoctorDashboard() {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch(
        `/api/spruce/conversations/${selectedConversation.id}/messages`,
        {
          method: "POST",
  ...
  return (
    <ModernLayout noPadding fullHeight>
      <div className="h-full flex bg-[#0d0d0d] text-white overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-semibold">
                      {selectedConversation.patient_name || "Unknown Patient"}
                    </h2>
                      ...
                      >
                        <div
                          className={`max-w-[70%] rounded-lg p-3 ${
                            msg.isFromPatient ? "bg-[#1a1a1a] text-white" : "bg-blue-600 text-white"
                          }`}
                        >
                          ...
                          <p
                            className={`text-xs mt-2 ${msg.isFromPatient ? "text-gray-500" : "text-blue-200"}`}
                          >
