      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#1e1e1e] border border-gray-800 rounded-md p-6 hover:border-gray-700 transition-colors cursor-pointer">
            ...
            <p className="text-sm text-gray-400">Access and manage all patient records</p>
          </div>
          ...
          <div className="bg-[#1e1e1e] border border-gray-800 rounded-md p-6 hover:border-gray-700 transition-colors cursor-pointer">
            ...
            <p className="text-sm text-gray-400">Access and manage all soap notes</p>
          </div>
          ...
          <div className="bg-[#1e1e1e] border border-gray-800 rounded-md p-6 hover:border-gray-700 transition-colors cursor-pointer">
            ...
            <p className="text-sm text-gray-400">Access and manage all hpi summaries</p>
          </div>
          ...
          <div className="bg-[#1e1e1e] border border-gray-800 rounded-md p-6 hover:border-gray-700 transition-colors cursor-pointer">
            ...
            <p className="text-sm text-gray-400">Access and manage all prescription history</p>
          </div>
          ...
          <div className="bg-[#1e1e1e] border border-gray-800 rounded-md p-6 hover:border-gray-700 transition-colors cursor-pointer">
            ...
            <p className="text-sm text-gray-400">Access and manage all lab results</p>
          </div>
          ...
          <div className="bg-[#1e1e1e] border border-gray-800 rounded-md p-6 hover:border-gray-700 transition-colors cursor-pointer">
            ...
            <p className="text-sm text-gray-400">Access and manage all imaging reports</p>
          </div>
        </div>
      </div>
    </AppLayoutSpruce>
