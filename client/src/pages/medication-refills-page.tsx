...
const MedicationRefillsPage: React.FC = () => {
  ...
  const getStatusBadge = (status: RefillRequest['status']) => {
    switch (status) {
      ...
      case 'approved':
        return <Badge variant="outline" className="bg-green-900/20 text-green-500 border-green-800">Approved</Badge>;
      case 'denied':
        return <Badge variant="outline" className="bg-red-900/20 text-red-500 border-red-800">Denied</Badge>;
      case 'needs_info':
        return <Badge variant="outline" className="bg-blue-900/20 text-blue-500 border-blue-800">Needs Info</Badge>;
      default:
    ...
    <BaseLayout>
      ...
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">Manage and process medication refill requests from pharmacies</p>
        </div>
