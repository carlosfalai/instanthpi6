      ...
      <div className="p-6">
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Leverage Claude 3.7 Sonnet to generate, explain, and improve code for your application.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p>
              The Claude Code Assistant can help you with various programming tasks, such as generating 
              new code components, explaining unfamiliar code, and improving existing implementations.
            </p>
            <p className="mt-2">
