                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      {setting.ageRangeMin && setting.ageRangeMax && (
                        <div>
                          ...
                          {setting.ageRangeMin} - {setting.ageRangeMax} years
                        </div>
                      )}
                      {setting.gender && setting.gender !== "all" && (
                        <div>
                          <span className="font-medium text-muted-foreground">Gender:</span>{" "}
                          {setting.gender.charAt(0).toUpperCase() + setting.gender.slice(1)}
                        </div>
                      )}
                    </div>
                  </CardContent>
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col space-y-1">
        ...
        <p className="text-muted-foreground">Events the AI has scheduled for your patients</p>
      </div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Send messages to multiple patients at once by uploading a CSV file with patient
          information.
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-6">
            <div className="grid w-full max-w-lg items-center gap-2">
              ...
              <p className="text-sm text-gray-500">
                CSV file must include columns for 'name' and 'phone'. Optional columns: 'email',
                'language'.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              ...
              <code className="text-sm">
                ...
                <br />
                John Doe,1234567890,john@example.com,english
                <br />
          ...
          <div className="space-y-6">
            ...
            {exceedsPatientLimit && (
              <div className="bg-red-50 border border-red-200 p-4 rounded-md text-red-800">
                ...
                The uploaded file contains more than 500 patients. Please reduce the number of
                patients and try again.
              </div>
            )}
            ...
            <div className="border rounded-md overflow-hidden">
                    ...
                    <tr key={patient.id}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            togglePatientSelection(patient.id, checked as boolean)
                          }
                        />
                      </td>
              ...
              {patientData.length > 10 && (
                <div className="px-6 py-3 bg-gray-50 text-sm text-gray-500">
                  Showing 10 of {patientData.length} patients. {patientData.length - 10} more not
                  displayed.
                </div>
              )}
            </div>
        ...
        {step === "customize" && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>
                    <code>{"{patient_email}"}</code> - Patient's email address (if available)
                  </li>
                </ul>
              </div>
              ...
              {patientData.length > 0 && (
                <div>
                  ...
                  <div className="p-4 bg-blue-50 rounded-md border border-blue-100 text-sm">
                    {getPatientMessage(patientData[0])
                      .split("\n")
                      .map((line, i) => (
                        <p key={i}>{line || <br />}</p>
                      ))}
            ...
            <div className="flex justify-end">
              <Button onClick={() => setStep("confirm")} disabled={!customMessage.trim()}>
                Review & Send
              </Button>
            </div>
          </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-md border border-gray-200 text-sm">
                    ...
                    <p>
                      <strong>Recipients:</strong> {selectedCount} patients
                    </p>
                  </div>
                </div>
...
export default function SchedulerPage() {
  ...
  return (
    <ModernLayout title="Scheduler" description="Manage appointments and schedule">
