...
import { AlertCircle, ArrowLeft, Clipboard, FileText, MessageSquare, SendHorizontal } from "lucide-react";
...
export default function PatientTreatmentPage() {
  ...
  useEffect(() => {
    ...
    Object.keys(treatmentProtocols).forEach(condition => {
      ...
      const defaultOptions = treatmentProtocols[condition as keyof typeof treatmentProtocols].sections[0].options.slice(0, 2);
      ...
      <div className="container mx-auto py-6 space-y-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500">Select recommended treatments and options for the current patient</p>
          </div>
