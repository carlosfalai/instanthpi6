...
const diagnosisList: Diagnosis[] = [
  {
    ...
    treatments: [
      ...
      {
        id: "1-2",
        name: "Stimulant medication (Methylphenidate, Amphetamine)",
        category: "medication",
        enabled: true,
      },
      {
        id: "1-3",
        name: "Non-stimulant medication options (Atomoxetine)",
        category: "medication",
        enabled: false,
      },
      {
        id: "1-4",
        name: "Cognitive behavioral therapy for ADHD",
        category: "referral",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "2-7",
        name: "Acetaminophen 500-1000 mg PO QID PRN",
        category: "medication",
        enabled: true,
      },
      ...
      {
        id: "2-10",
        name: "Emergency department referral if needed",
        category: "referral",
        enabled: false,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "2c-9",
        name: "Abdominal/pelvic CT with contrast",
        category: "testing",
        enabled: false,
      },
      ...
      {
        id: "2c-15",
        name: "Hyoscyamine 0.125 mg SL QID PRN",
        category: "medication",
        enabled: false,
      },
      ...
      {
        id: "2c-22",
        name: "Food diary and trigger identification",
        category: "lifestyle",
        enabled: true,
      },
    ],
  },
  {
    ...
    category: "acute",
    standardProtocol:
      "Rest for 48 hours, then gentle movement. Acetaminophen or NSAIDs for pain. Apply heat/ice 20 minutes at a time. If no improvement in 1 week or worsening symptoms, in-person evaluation.",
    standardProtocolEnabled: false,
    treatments: [
      {
        id: "3-4",
        name: "NSAIDs for pain (Ibuprofen/Naproxen)",
        category: "medication",
        enabled: true,
      },
      {
      ...
      {
        id: "3-8",
        name: "Follow-up in 2 weeks if not improving",
        category: "followup",
        enabled: true,
      },
    ],
  },
  {
    ...
    treatments: [
      {
        id: "4-1",
        name: "Mental health assessment using GAD-7 scale",
        category: "testing",
        enabled: true,
      },
      ...
      {
        id: "4-3",
        name: "SSRI medication (Sertraline, Escitalopram)",
        category: "medication",
        enabled: true,
      },
      {
        id: "4-4",
        name: "Benzodiazepines for short-term crisis management",
        category: "medication",
        enabled: false,
      },
      {
        id: "4-5",
        name: "Cognitive behavioral therapy referral",
        category: "referral",
        enabled: true,
      },
      ...
      {
        id: "4-12",
        name: "Non-benzodiazepine anxiolytics (Buspirone)",
        category: "medication",
        enabled: false,
      },
    ],
  },
  {
    ...
    category: "chronic",
    standardProtocol:
      "For mild-moderate asthma: Daily inhaled corticosteroid (low dose fluticasone) and rescue albuterol inhaler as needed. Review inhaler technique. Create asthma action plan. Follow-up in 3 months.",
    standardProtocolEnabled: false,
    treatments: [
      { id: "5-1", name: "Pulmonary function tests", category: "testing", enabled: true },
      {
        id: "5-2",
        name: "Inhaled corticosteroids (Fluticasone)",
        category: "medication",
        enabled: true,
      },
      {
        id: "5-3",
        name: "Short-acting beta agonists (Albuterol)",
        category: "medication",
        enabled: true,
      },
      {
        id: "5-4",
        name: "Long-acting beta agonists if needed",
        category: "medication",
        enabled: false,
      },
      {
        id: "5-5",
        name: "Leukotriene modifiers (Montelukast)",
        category: "medication",
        enabled: false,
      },
  ...
  // Added more detailed treatments for the key conditions
  {
    ...
    category: "chronic",
    standardProtocol:
      "Initial management with metformin 500mg twice daily with meals, titrate up as tolerated. Mediterranean diet and 150 min/week exercise. A1C check every 3 months. Consider referral to diabetes education.",
    standardProtocolEnabled: false,
    treatments: [
      ...
      {
        id: "15-4",
        name: "Metformin as first-line therapy",
        category: "medication",
        enabled: true,
      },
      {
      ...
      {
        id: "15-8",
        name: "Insulin if needed for severe cases",
        category: "medication",
        enabled: false,
      },
      {
        id: "15-9",
        name: "Medical nutrition therapy referral",
        category: "referral",
        enabled: true,
      },
      ...
      {
        id: "15-11",
        name: "Regular exercise program (150 min/week)",
        category: "lifestyle",
        enabled: true,
      },
  ...
  },
  {
    ...
    category: "chronic",
    standardProtocol:
      "First-line: ACE inhibitor (lisinopril 10mg daily) or ARB if ACE intolerant. DASH diet, sodium restriction, physical activity. BP goal <130/80. Follow-up in 1 month to assess response.",
    standardProtocolEnabled: false,
    treatments: [
      {
        id: "22-1",
        name: "Multiple BP measurements to confirm diagnosis",
        category: "testing",
        enabled: true,
      },
      ...
      {
        id: "22-12",
        name: "Monthly follow-up until controlled",
        category: "followup",
        enabled: true,
      },
    ],
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "9-7",
        name: "Benzonatate for symptom control",
        category: "medication",
        enabled: false,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "hz-2",
        name: "Valacyclovir 1000 mg PO TID x 7 days",
        category: "medication",
        enabled: true,
      },
      {
        id: "hz-3",
        name: "Famciclovir 500 mg PO TID x 7 days",
        category: "medication",
        enabled: false,
      },
      {
        id: "hz-4",
        name: "Acyclovir 800 mg PO 5 times daily x 7 days",
        category: "medication",
        enabled: false,
      },
      {
        id: "hz-5",
        name: "Acetaminophen 500-1000 mg PO QID PRN x 14 days",
        category: "medication",
        enabled: true,
      },
      {
        id: "hz-6",
        name: "Ibuprofen 400 mg PO QID PRN x 14 days",
        category: "medication",
        enabled: false,
      },
      {
        id: "hz-7",
        name: "Shingrix® vaccine prescription",
        category: "medication",
        enabled: true,
      },
      {
        id: "hz-8",
        name: "Patient education on infection control",
        category: "lifestyle",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "12-9",
        name: "Morphine sustained-release 15mg PO BID",
        category: "medication",
        enabled: false,
      },
      {
        id: "12-10",
        name: "Oxycodone sustained-release 10mg PO BID",
        category: "medication",
        enabled: false,
      },
      {
        id: "12-11",
        name: "Chronic pain specialist referral",
        category: "referral",
        enabled: true,
      },
      ...
      {
        id: "12-17",
        name: "Interventional pain management referral",
        category: "referral",
        enabled: false,
      },
      ...
      {
        id: "12-19",
        name: "Regular physical activity guidance",
        category: "lifestyle",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      {
        id: "13-1",
        name: "Culture of eye discharge (if needed)",
        category: "testing",
        enabled: false,
      },
      ...
      {
        id: "13-8",
        name: "Ophthalmology referral if needed",
        category: "referral",
        enabled: false,
      },
      ...
      {
        id: "13-10",
        name: "Contagion prevention counseling",
        category: "lifestyle",
        enabled: true,
      },
    ],
  },
  {
    ...
    treatments: [
      ...
      {
        id: "14-5",
        name: "SSRI medication (e.g., Sertraline)",
        category: "medication",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "17-4",
        name: "H2 blocker therapy (e.g., famotidine)",
        category: "medication",
        enabled: false,
      },
      {
        id: "17-5",
        name: "Antacids for breakthrough symptoms",
        category: "medication",
        enabled: true,
      },
      {
        id: "17-6",
        name: "Lifestyle modifications education",
        category: "lifestyle",
        enabled: true,
      },
      {
        id: "17-7",
        name: "Dietary trigger avoidance counseling",
        category: "lifestyle",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "19-8",
        name: "Riboflavin (Vitamin B2) 400mg daily",
        category: "medication",
        enabled: false,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "27-3",
        name: "Acetaminophen for symptom relief",
        category: "medication",
        enabled: true,
      },
      ...
      {
        id: "27-9",
        name: "Antibiotics (only if bacterial cause suspected)",
        category: "medication",
        enabled: false,
      },
      {
        id: "27-10",
        name: "ENT referral if severe or persistent",
        category: "referral",
        enabled: false,
      },
    ],
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "32-4",
        name: "Amoxicillin 500mg TID or 875mg BID for 10 days",
        category: "medication",
        enabled: true,
      },
      ...
      {
        id: "32-6",
        name: "Azithromycin (if penicillin allergic)",
        category: "medication",
        enabled: false,
      },
  ...
  },
  {
    ...
    treatments: [
      {
        id: "34-1",
        name: "Shoulder X-ray (AP, lateral, axillary views)",
        category: "testing",
        enabled: true,
      },
      {
        id: "34-2",
        name: "Echo-guided examination of the shoulder",
        category: "testing",
        enabled: false,
      },
      ...
      {
        id: "34-7",
        name: "Subacromial corticosteroid injection",
        category: "medication",
        enabled: false,
      },
      ...
      {
        id: "34-10",
        name: "Short-term sling if acute trauma",
        category: "lifestyle",
        enabled: false,
      },
      {
        id: "34-11",
        name: "Orthopedics referral if indicated",
        category: "referral",
        enabled: false,
      },
      {
        id: "34-12",
        name: "Patient education on gentle mobilization",
        category: "lifestyle",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      {
        id: "35-1",
        name: "Trigger identification and avoidance",
        category: "lifestyle",
        enabled: true,
      },
      ...
      {
        id: "35-7",
        name: "Bleach baths for infection prevention",
        category: "lifestyle",
        enabled: false,
      },
  ...
  {
    id: "36",
    name: "Suspected ADHD in Adults (Diagnostic Evaluation Phase)",
    category: "mental",
    standardProtocol: "",
    standardProtocolEnabled: false,
    treatments: [],
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "55-6",
        name: "Lifestyle and nutrition counseling",
        category: "lifestyle",
        enabled: true,
      },
      ...
      {
        id: "55-11",
        name: "Bone density testing when appropriate",
        category: "testing",
        enabled: false,
      },
      {
        id: "55-12",
        name: "Annual follow-up for routine care",
        category: "followup",
        enabled: true,
      },
    ],
  },
  {
    ...
    treatments: [
      ...
      {
        id: "37-5",
        name: "Amoxicillin 500mg PO TID (if bacterial)",
        category: "medication",
        enabled: false,
      },
      {
        id: "37-6",
        name: "Azithromycin 500mg PO daily (if bacterial)",
        category: "medication",
        enabled: false,
      },
      {
        id: "37-7",
        name: "Patient education on viral causes",
        category: "lifestyle",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "40-5",
        name: "SSRI therapy (sertraline, escitalopram)",
        category: "medication",
        enabled: true,
      },
      {
        id: "40-6",
        name: "Short-term benzodiazepine therapy",
        category: "medication",
        enabled: false,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "41-3",
        name: "Atypical antipsychotic if needed",
        category: "medication",
        enabled: false,
      },
      {
        id: "41-4",
        name: "Thyroid and kidney function monitoring",
        category: "testing",
        enabled: true,
      },
  ...
  },
  {
    ...
    treatments: [
      ...
      {
        id: "42-4",
        name: "Modafinil for excessive sleepiness",
        category: "medication",
        enabled: false,
      },
      ...
      {
        id: "42-6",
        name: "Environmental sleep optimization",
        category: "lifestyle",
        enabled: true,
      },
      {
        id: "42-7",
        name: "Regular sleep schedule counseling",
        category: "lifestyle",
        enabled: true,
      },
...
export default function KnowledgeBasePage() {
  ...
  const selectedDiagnosisData = selectedDiagnosis
    ? editedDiagnoses.find((d) => d.id === selectedDiagnosis)
    : null;

  // Group treatments by category
  const groupedTreatments =
    selectedDiagnosisData?.treatments.reduce(
      (acc, treatment) => {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-500">
              Customize treatment protocols and documentation preferences by medical condition
            </p>
          </div>
              ...
              {filteredDiagnoses.length === 0 && (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-gray-500 max-w-md">
                    We couldn't find any medical conditions matching your search criteria. Try
                  ...
                  <div className="space-y-6">
                    <div className="border-b border-gray-800 pb-6">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(enabled) =>
                              handleProtocolToggle(selectedDiagnosisData.id, enabled)
                            }
                          />
                        </div>
                      </div>
                      ...
                      <p className="text-sm text-gray-400 mb-3">
                        This protocol will be offered as a single-click option when the AI detects
                        this condition
                      </p>
                        ...
                        <div>
                          <div className="p-3 bg-[#262626] rounded-md mb-3">
                            <p className="text-sm text-gray-300 whitespace-pre-wrap">
                              {selectedDiagnosisData.standardProtocol ||
                                "No standard protocol defined yet."}
                            </p>
                          </div>
                          <Button
                            variant="outline"
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mb-6">
                        Toggle each option to customize your preferred planning. The AI will
                        reference these settings when providing recommendations.
                      </p>

                      {selectedDiagnosisData.treatments.length === 0 ? (
                        <div className="text-center p-4 bg-[#262626] rounded-md">
                          <p className="text-gray-400">
                            No planning options defined for this condition yet.
                          </p>
                        </div>
                      ) : (
                        <div className="space-y-6">
              ...
              <CardContent className="py-12">
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Select a medical condition from the list to view and customize treatment
                    protocols.
                  </p>
                </div>
              </CardContent>
