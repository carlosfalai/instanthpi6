    ...
    <div className="w-full sticky top-0 z-10 bg-[#121212] border-b border-gray-800 px-3 py-2.5">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <div
            className={`flex items-center px-2 py-1 rounded-md ${config.bgColor} ${config.color} text-xs font-medium mr-2`}
          >
            {config.icon}
        ...
        <div className="text-sm font-medium text-gray-300 truncate">{patientName}</div>
      </div>
    </div>
  );
}
