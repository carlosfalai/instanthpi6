      ...
      <Tabs defaultValue="ai-suggestions" className="flex-1 flex flex-col">
        <div className="px-4 pt-2">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="ai-suggestions" className="flex items-center">
              <ListChecks className="h-4 w-4 mr-2" />
              AI Suggestions
            </TabsTrigger>
            <TabsTrigger value="treatment-selection" className="flex items-center">
              <Pill className="h-4 w-4 mr-2" />
              Treatments
            </TabsTrigger>
            <TabsTrigger value="pending-items" className="flex items-center">
          ...
          <ScrollArea className="flex-1 p-4 overflow-y-auto">
            <div className="space-y-4">
              ...
              {pendingItems.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-64">
                  <p className="text-gray-500 mb-4">No pending items found.</p>
                </div>
              )}
            </div>
          </ScrollArea>
