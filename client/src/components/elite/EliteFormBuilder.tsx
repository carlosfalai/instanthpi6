...
import { Plus, Trash2, Move, Eye, Edit2, Check, Brain, Webhook, Save, Play, Settings2, FileText } from 'lucide-react';
...
interface EliteFormBuilderProps {
    onSave?: (schema: { fields: FormField[]; aiConfig: AIContextConfig; apiConfig: APIIntegrationConfig }) => void;
        ...
        <div className="flex flex-col h-[calc(100vh-8rem)] gap-4">
            ...
            <div className="flex gap-6 flex-1 overflow-hidden">
                ...
                {activeTab === 'builder' && (
                    <>
                        {/* Sidebar - Tools */}
                        <EliteCard className="w-64 flex-shrink-0 flex flex-col gap-4 overflow-y-auto" hover={false}>
                            <h3 className="text-lg font-bold text-foreground mb-2">Toolbox</h3>
                            <div className="grid grid-cols-1 gap-2">
                                {(['text', 'number', 'email', 'textarea', 'date', 'select'] as FormFieldType[]).map((type) => (
                                    <EliteButton
                                        key={type}
                                        variant="ghost"
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                                        <div className="flex items-center gap-3">
                                            ...
                                            />
                                            <label htmlFor="required-check" className="text-sm font-medium text-foreground cursor-pointer">Required Field</label>
                                        </div>
                                    </div>
                                </div>
                            </EliteCard>
                    ...
                    <div className="flex-1 flex gap-6">
                        <EliteCard className="w-1/3 space-y-6" glow>
                            ...
                            <p className="text-muted-foreground text-sm">
                                Define the "Artificial Identity" that will process this form. This ensures the output matches your personal style.
                            </p>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest font-bold text-muted-foreground">Tone of Voice</label>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-xs mb-3">
                                        Paste examples of your ideal output here. The AI will "back-engineer" your style from these examples.
                                    </p>
                                    <textarea
                    ...
                    <div className="flex-1 flex gap-6">
                        <EliteCard className="w-full max-w-2xl mx-auto space-y-6" hover={false}>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-sm text-muted-foreground">{apiConfig.enabled ? 'Enabled' : 'Disabled'}</span>
                                    <button
                            ...
                            <div className={cn("space-y-6 transition-opacity", !apiConfig.enabled && "opacity-50 pointer-events-none")}>
                                <div className="grid grid-cols-4 gap-4">
                                    <div className="col-span-1">
                                        <label className="text-xs uppercase tracking-widest font-bold text-muted-foreground mb-2 block">Method</label>
                                        <select
                                ...
                                <div>
                                    <label className="text-xs uppercase tracking-widest font-bold text-muted-foreground mb-2 block">Payload Mapping (JSON)</label>
