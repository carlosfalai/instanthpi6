...
export function EliteDocumentPreview({
  isOpen,
  onClose,
  documentTitle,
  documentContent,
  patientName,
}: EliteDocumentPreviewProps) {
          ...
          <div className="max-w-[80%] mx-auto">
            <div className="text-center border-b-2 border-black pb-4 mb-6">
              ...
              <p className="text-xs uppercase tracking-widest">
                InstantConsult Elite Medical Group
              </p>
            </div>

            <div className="whitespace-pre-wrap min-h-[400px]">{documentContent}</div>
