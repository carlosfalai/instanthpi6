          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" className={`${textColor} ${buttonHoverColor}`}>
            ...
            <div key={date} className="space-y-3">
              ...
              {messagesByDate[date].map((message, index) => (
                ...
                >
                  ...
                  <div
                    className={`max-w-[75%] ${message.isFromPatient ? messageFromPatientBg : messageFromMeBg} p-3 rounded-lg`}
                  >
