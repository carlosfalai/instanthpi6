    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      {showAura && (
        <>
          ...
          <div className="fixed bottom-[-15%] right-[-10%] w-[600px] h-[600px] bg-secondary/5 rounded-full blur-[150px] animate-glow-pulse pointer-events-none" style={{ animationDelay: '-2s' }} />
        </>
      )}
          ...
          <div className="flex h-full flex-col pt-16">
            ...
            <div className="border-t border-border p-4 space-y-4">
              ...
              <div className="rounded-xl glass p-3 border border-border/50">
                <p className="text-xs font-semibold text-foreground" style={{ fontFamily: 'Outfit, sans-serif' }}>InstantHPI Elite</p>
