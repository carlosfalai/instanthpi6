  ...
  return (
    <div className="flex flex-col h-full bg-[#121212] text-white">
      ...
      <ScrollArea className="flex-1">
        ...
        {error && <div className="text-red-400 text-center p-4">Failed to load pending items</div>}

        {!isLoading && filteredItems.length === 0 && (
          <div className="text-gray-500 text-center p-4">No pending items found</div>
        )}
                  ...
                  >
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        <span
                          className={`font-medium ${item.status === "completed" ? "line-through text-gray-500" : ""}`}
                        >
                          {item.description}
                        </span>
                      </div>
