...
test.describe("Button Functionality Tests", () => {
  ...
  test("1. Dashboard refresh buttons work", async ({ page }) => {
    ...
    const refreshButtons = page.locator(
      'button:has([class*="RefreshCw"]), button[title*="refresh" i]'
    );
  ...
  test("5. Modal/Dialog buttons work", async ({ page }) => {
    ...
    const modalTriggers = page.locator(
      'button:has-text("Edit"), button:has-text("Add"), button:has-text("Create"), button:has-text("New")'
    );
  ...
  test("7. Delete buttons work", async ({ page }) => {
    ...
    const deleteButtons = page.locator(
      'button:has-text("Delete"), button:has-text("Remove"), button[title*="delete" i]'
    );
